...
adsorbent_options = [m["name"] for m in params["separation_parameters"]["absorption"]["solvents"]]
...
selected_solvent = st.selectbox("Choose solvent", adsorbent_options)

chosen_params = get_selected_params("absorption", selected_solvent)
st.caption(f"Active solvent: **{selected_solvent}**")
